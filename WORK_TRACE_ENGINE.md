...
```text
Work Trace T-204
14:31 Teams  재무팀의 6월 실제 인건비 확인 요청  ← 시작
...
- 시작한 이유: Trace의 첫 요청 또는 처음 열린 업무 창
- 멈춘 곳: 중단 직전 마지막 Span
...
창 제목만으로는 “6월 마감 전에 실제 인건비를 확인해 주세요”라는 요청 문장을 안정적으로 얻을 수 없습니다. 메시지 본문이 필요한 조직은 다음 입력 중 하나를 명시적으로 켭니다.
