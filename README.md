...
macOS 단축키는 `Command + Shift + Space`입니다. 몇 시간 뒤나 다음 날 이어야 할 작업은 `Ctrl + Shift + M`으로 **나중에 이어보기**에 남길 수 있습니다.
...
| 열기까지 | 자리를 비운 동안 | 현재 |
| --- | --- | --- |
| Teams → Explorer → Excel | Outlook · 회의 일정 | Excel · 비용 증감 확인 |

현재 파일을 연 이유와 세 구간만 보면 다음 행동으로 돌아갈 수 있습니다.
